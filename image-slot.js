...
(() => {
  ...
  const stylesheet =
    ...
    '.frame{position:absolute;inset:0;overflow:hidden;background:var(--is-frame-bg,rgba(127,127,127,.08))}' +
    ...
    '.ring{position:absolute;inset:0;pointer-events:none;border:1.5px dashed currentColor;display:var(--is-ring-display,block);' +
